        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal m-t-20" action="{{ route('password.email') }}" method="post" data-parsley-validate novalidate>
                ...
                <div class="form-group text-center m-t-40">
                    <div class="col-xs-12">
                        <button class="btn btn-pink btn-orange btn-block text-uppercase waves-effect waves-light" type="submit">Enviar Contraseña Restablecer Enlace</button>
                    </div>
                </div>

                <div class="form-group m-t-30 m-b-0">
                    <div class="col-sm-12">
                        <a href="{{ route('login') }}" class="text-dark"><i class="fa fa-lock m-r-5"></i> Iniciar Sesion</a>
                    </div>
                </div>
            </form>
